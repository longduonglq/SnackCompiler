...
.globl $n
$n:
  .word 0                                  # Initial value of global var: n
...
main:
  ...
  la a0, const_2                           # Load string literal: "Gimme your input ehehe"
  ...
  sw a0, 44(sp)                            # [push-temp `arg 0-th`] push arg 0-th `string` of "str_to_int" to stack
  addi sp, sp, 44                          # [deflate-stack] shrink stack
  jal $str_to_int                          # Call function: str_to_int
  addi sp, sp, -44                         # [inflate-stack] inflate stack
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  sw a0, $n, t1                            # Store A0 into global var n
...
label_2:                                   # While loop body
  addi sp, sp, 48                          # [deflate-stack] shrink stack
  jal $call_me                             # Call function: call_me
  addi sp, sp, -48                         # [inflate-stack] inflate stack
  lw a0, $i                                # Load identifier label into A0
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
...
label_3:                                   # Bottom of while loop
  la a0, const_3                           # Load string literal: "ending"
  sw a0, 44(sp)                            # [push-temp `arg 0-th`] push arg 0-th `arg` of "print" to stack
  addi sp, sp, 44                          # [deflate-stack] shrink stack
  jal $print                               # Call function: print
  addi sp, sp, -44                         # [inflate-stack] inflate stack
...
label_11:                                  # Top of while loop
  ...
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_14:                                  # Evaluate OR second expression
...
label_15:                                  # Exit binary expression local label
  li t0, 1                                 # Store 1 into temp reg
...
label_16:                                  # Not none
  ...
  bltu a0, t0, label_17                    # Index within bound
  j errOOB                                 # Go to OOB error handler
label_17:                                  # Index within bound
...
label_21:                                  # Exit binary expression local label
  ...
  beqz a0, label_22                        # If A0 == 0, jump to falseElseBranch
  la a0, const_9                           # Load string literal: "Error: Negative sign not at beginning of string"
  sw a0, 44(sp)                            # [push-temp `arg 0-th`] push arg 0-th `arg` of "print" to stack
  addi sp, sp, 44                          # [deflate-stack] shrink stack
  jal $print                               # Call function: print
  addi sp, sp, -44                         # [inflate-stack] inflate stack
...
label_18::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_26:                                  # Evaluate OR second expression
  la a0, const_10                          # Load string literal: "0"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_27:                                  # Exit binary expression local label
  beqz a0, label_24                        # If A0 == 0, jump to falseElseBranch
  li a0, 0                                 # Load integer literal: 0
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of str_to_int
...
label_30:                                  # Evaluate OR second expression
  la a0, const_11                          # Load string literal: "1"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
...
label_31:                                  # Exit binary expression local label
  beqz a0, label_28                        # If A0 == 0, jump to falseElseBranch
  li a0, 1                                 # Load integer literal: 1
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of str_to_int
  sw a0, -16(t0)                           # [fn=str_to_int] load NON-LOCAL param
...
label_34:                                  # Evaluate OR second expression
  la a0, const_12                          # Load string literal: "2"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
...
label_32::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_38:                                  # Evaluate OR second expression
  la a0, const_13                          # Load string literal: "3"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_39:                                  # Exit binary expression local label
  beqz a0, label_36                        # If A0 == 0, jump to falseElseBranch
...
label_36::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_42:                                  # Evaluate OR second expression
  la a0, const_13                          # Load string literal: "3"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  ...
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_43:                                  # Exit binary expression local label
  beqz a0, label_40                        # If A0 == 0, jump to falseElseBranch
  li a0, 3                                 # Load integer literal: 3
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of str_to_int
  sw a0, -16(t0)                           # [fn=str_to_int] load NON-LOCAL param
...
label_40::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_46:                                  # Evaluate OR second expression
  la a0, const_14                          # Load string literal: "4"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_47:                                  # Exit binary expression local label
  beqz a0, label_44                        # If A0 == 0, jump to falseElseBranch
...
label_44::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_50:                                  # Evaluate OR second expression
  la a0, const_15                          # Load string literal: "5"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_51:                                  # Exit binary expression local label
  beqz a0, label_48                        # If A0 == 0, jump to falseElseBranch
...
label_48::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_54:                                  # Evaluate OR second expression
  la a0, const_16                          # Load string literal: "6"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_55:                                  # Exit binary expression local label
  beqz a0, label_52                        # If A0 == 0, jump to falseElseBranch
...
label_52::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_58:                                  # Evaluate OR second expression
  la a0, const_17                          # Load string literal: "7"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_59:                                  # Exit binary expression local label
  beqz a0, label_56                        # If A0 == 0, jump to falseElseBranch
...
label_56::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_62:                                  # Evaluate OR second expression
  la a0, const_18                          # Load string literal: "8"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_63:                                  # Exit binary expression local label
  beqz a0, label_60                        # If A0 == 0, jump to falseElseBranch
...
label_60::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_66:                                  # Evaluate OR second expression
  la a0, const_19                          # Load string literal: "9"
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  sw t1, 40(sp)                            # [push-temp `left-expr`] push left string to stack
  sw a0, 36(sp)                            # [push-temp `right-expr`] push right string to stack
  addi sp, sp, 36                          # [deflate-stack] shrink stack
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_67:                                  # Exit binary expression local label
  beqz a0, label_64                        # If A0 == 0, jump to falseElseBranch
...
label_64::
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_74:                                  # Evaluate OR second expression
  ...
  jal strEql                               # call string == function
  addi sp, sp, -36                         # [inflate-stack] restore stack
label_75:                                  # Exit binary expression local label
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
  li t0, 1                                 # Load 1 into temp reg
  beq a0, t0, label_73                     # Compare if A0 is true
  j label_72                               # Jump to exit binary expr local label
label_72:                                  # Evaluate OR second expression
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 40(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_76:                                  # Evaluate OR second expression
...
label_77:                                  # Exit binary expression local label
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  or a0, a0, t1                            # or: OR A0 and T1
label_73:                                  # Exit binary expression local label
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
  li t0, 1                                 # Load 1 into temp reg
  beq a0, t0, label_71                     # Compare if A0 is true
  j label_70                               # Jump to exit binary expr local label
label_70:                                  # Evaluate OR second expression
  lw a0, -20(fp)                           # [fn=str_to_int] load local VAR `char: str` TO reg `a0`
  sw a0, 40(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_78:                                  # Evaluate OR second expression
  ...
  jal strEql                               # call string == function
  addi sp, sp, -32                         # [inflate-stack] restore stack
label_79:                                  # Exit binary expression local label
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  or a0, a0, t1                            # or: OR A0 and T1
label_71:                                  # Exit binary expression local label
  beqz a0, label_68                        # If A0 == 0, jump to falseElseBranch
  lw a0, -12(fp)                           # [fn=str_to_int] load local VAR `result: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_80:                                  # Evaluate OR second expression
  lw a0, -24(fp)                           # [fn=str_to_int] load local VAR `sign: int` TO reg `a0`
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  mul a0, t1, a0                           # * two operands
label_81:                                  # Exit binary expression local label
  lw ra, -4(fp)                            # Get return address
  lw fp, -8(fp)                            # Use control link to restore caller's fp
  addi sp, sp, 80                          # Restore stack pointer
  jr ra                                    # Return to caller
  jal label_69
label_68::
  la a0, const_23                          # Load string literal: "Error: Invalid character in string"
  sw a0, 44(sp)                            # [push-temp `arg 0-th`] push arg 0-th `arg` of "print" to stack
  addi sp, sp, 44                          # [deflate-stack] shrink stack
  jal $print                               # Call function: print
  addi sp, sp, -44                         # [inflate-stack] inflate stack
...
label_19::
  ...
  lw a0, -32(fp)                           # [fn=str_to_int] load local VAR `i: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_82:                                  # Evaluate OR second expression
  li a0, 1                                 # Load integer literal: 1
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  add a0, t1, a0                           # + two operands
label_83:                                  # Exit binary expression local label
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of str_to_int
  sw a0, -32(t0)                           # [fn=str_to_int] load NON-LOCAL param
  lw a0, -12(fp)                           # [fn=str_to_int] load local VAR `result: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_86:                                  # Evaluate OR second expression
  li a0, 10                                # Load integer literal: 10
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  mul a0, t1, a0                           # * two operands
label_87:                                  # Exit binary expression local label
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_84:                                  # Evaluate OR second expression
  lw a0, -16(fp)                           # [fn=str_to_int] load local VAR `digit: int` TO reg `a0`
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  add a0, t1, a0                           # + two operands
label_85:                                  # Exit binary expression local label
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of str_to_int
...
label_13:                                  # Bottom of while loop
  lw a0, -12(fp)                           # [fn=str_to_int] load local VAR `result: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_88:                                  # Evaluate OR second expression
  lw a0, -24(fp)                           # [fn=str_to_int] load local VAR `sign: int` TO reg `a0`
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  mul a0, t1, a0                           # * two operands
label_89:                                  # Exit binary expression local label
  lw ra, -4(fp)                            # Get return address
  lw fp, -8(fp)                            # Use control link to restore caller's fp
  addi sp, sp, 80                          # Restore stack pointer
  jr ra                                    # Return to caller
  j label_10                               # [fn=str_to_int] jump to epilogue
label_10:                                  # Epilogue
...
.globl $call_me
$call_me:
  addi sp, sp, -76                         # [fn=call_me] Reserve space for stack frame
  sw ra, 72(sp)                            # [fn=call_me] Save return address.
  sw fp, 68(sp)                            # [fn=call_me] Save control link.
  addi fp, sp, 76                          # [fn=call_me] `fp` is at old `sp`.
  li a0, 0                                 # Load integer literal: 0
  sw a0, -12(fp)                           # [fn=call_me] store local VAR `a: int` FROM reg `a0`
  li a0, 0                                 # Load integer literal: 0
  sw a0, -16(fp)                           # [fn=call_me] store local VAR `b: int` FROM reg `a0`
  li a0, 0                                 # Load integer literal: 0
  sw a0, -20(fp)                           # [fn=call_me] store local VAR `c: int` FROM reg `a0`
  li a0, 0                                 # Load integer literal: 0
  sw a0, -24(fp)                           # [fn=call_me] store local VAR `i: int` FROM reg `a0`
  li a0, 15                                # Load integer literal: 15
  sw a0, -28(fp)                           # [fn=call_me] store local VAR `n: int` FROM reg `a0`
  la a0, const_24                          # Load string literal: "I got called!!!"
  sw a0, 44(sp)                            # [push-temp `arg 0-th`] push arg 0-th `arg` of "print" to stack
  addi sp, sp, 44                          # [deflate-stack] shrink stack
  jal $print                               # Call function: print
  addi sp, sp, -44                         # [inflate-stack] inflate stack
  la a0, const_25                          # Load string literal: "I was called with hope to constant propagate"
  sw a0, 44(sp)                            # [push-temp `arg 0-th`] push arg 0-th `arg` of "print" to stack
  addi sp, sp, 44                          # [deflate-stack] shrink stack
  jal $print                               # Call function: print
  addi sp, sp, -44                         # [inflate-stack] inflate stack
  lw a0, -12(fp)                           # [fn=call_me] load local VAR `a: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of call_me
  sw a0, -16(t0)                           # [fn=call_me] load NON-LOCAL param
  lw a0, -16(fp)                           # [fn=call_me] load local VAR `b: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of call_me
  sw a0, -20(t0)                           # [fn=call_me] load NON-LOCAL param
  lw a0, -20(fp)                           # [fn=call_me] load local VAR `c: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of call_me
  sw a0, -12(t0)                           # [fn=call_me] load NON-LOCAL param
label_91:                                  # Top of while loop
  lw a0, -24(fp)                           # [fn=call_me] load local VAR `i: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_94:                                  # Evaluate OR second expression
  lw a0, -28(fp)                           # [fn=call_me] load local VAR `n: int` TO reg `a0`
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  bge a0, t1, label_96                     # <=: Compare if T1 <= A0
  li a0, 0                                 # A0 is NOT greater than T1, Set A0 to False (0)
  j label_97                               # Jump to exit local label
label_96:                                  # Less than or equal to local label
  li a0, 1                                 # A0 is greater than T1, Set A0 to True (1)
label_97:                                  # Exit local label
label_95:                                  # Exit binary expression local label
  li t0, 1                                 # Store 1 into temp reg
  beq a0, t0, label_92                     # Check if condition is true
  j label_93                               # Jump to bottom of while loop to exit
label_92:                                  # While loop body
  addi sp, sp, 48                          # [deflate-stack] shrink stack
  jal $call_me_I_do_nothing                # Call function: call_me_I_do_nothing
  addi sp, sp, -48                         # [inflate-stack] inflate stack
  lw a0, -24(fp)                           # [fn=call_me] load local VAR `i: int` TO reg `a0`
  sw a0, 44(sp)                            # [push-temp `left-operand`] Store binop's left operand to stack
label_98:                                  # Evaluate OR second expression
  li a0, 1                                 # Load integer literal: 1
  lw t1, 44(sp)                            # [peek-temp `left-operand`] load binop's left operand from stack to `T1`
  add a0, t1, a0                           # + two operands
label_99:                                  # Exit binary expression local label
  sw a0, 44(sp)                            # [push-temp `assignt-stmt's value`] push RHS to temp-stack
  mv t0, fp                                # Get static link of call_me
  sw a0, -24(t0)                           # [fn=call_me] load NON-LOCAL param
  j label_91                               # Go back to top of while loop
label_93:                                  # Bottom of while loop
  mv a0, zero                              # [fn=call_me] Returning None implicitly
  j label_90                               # [fn=call_me] jump to epilogue
label_90:                                  # Epilogue
  lw ra, -4(fp)                            # get return addr
  lw fp, -8(fp)                            # Use control link to restore caller's fp
  addi sp, sp, 76                          # restore stack ptr
  jr ra                                    # return to caller
  #--------------------------------------------------( call_me_I_do_nothing )-------------------------------------------------- # 

.globl $call_me_I_do_nothing
$call_me_I_do_nothing:
  addi sp, sp, -56                         # [fn=call_me_I_do_nothing] Reserve space for stack frame
  sw ra, 52(sp)                            # [fn=call_me_I_do_nothing] Save return address.
  sw fp, 48(sp)                            # [fn=call_me_I_do_nothing] Save control link.
  addi fp, sp, 56                          # [fn=call_me_I_do_nothing] `fp` is at old `sp`.
  j label_100                              # [fn=call_me_I_do_nothing] jump to epilogue
label_100:                                 # Epilogue
  lw ra, -4(fp)                            # get return addr
  lw fp, -8(fp)                            # Use control link to restore caller's fp
...
errDIV:
  ...
  la a1, const_28                          # Load error message as str
  addi a1, a1, 16                          # Load address of attribute __str__
  j abort                                  # Abort
...
errOOB:
  ...
  la a1, const_29                          # Load error message as str
  addi a1, a1, 16                          # Load address of attribute __str__
  j abort                                  # Abort
...
wrapBoolean:
  ...
  beq a0, t0, label_101                    # Check which boolean branch to go to
  la a0, const_0                           # Load False constant's address into A0
  jr ra                                    # Go back
label_101:                                 # Label for true branch
...
concatenateList:
  ...
  lw t0, 4(fp)                             # t0 = arg1
  lw t1, 0(fp)                             # t1 = arg2
  beqz t0, label_102                       # asserts t0 not None
  beqz t1, label_102                       # asserts t1 not None
...
label_104:                                 # copy arg1 to destination
  beqz s2, label_106                       # loop when s2 > 0; else start initialize the copying of arg2
  ...
  j label_104                              # continue loop
label_106:                                 # preparing to copy arg2
  lw s1, 0(fp)                             # s1 = arg2
  lw s2, 12(s1)                            # s2 = arg2.len
  addi s1, s1, 16                          # s1 = &arg2[0]
  #..................................................( Copy arg2 into allocated list ).................................................. # 
label_105:                                 # copy arg2
  beqz s2, label_103                       # when done copying, go to epilogue
...
label_107:                                 # copying contents from stack-list to heap-list
  lw t3, 0(t1)                             # t3 = stack-arr[0]
  sw t3, 0(t2)                             # heap-arr[0] = t3
  addi t1, t1, -4                          # stack-arr -= 4
  addi t2, t2, 4                           # heap-arr += 4
  addi t0, t0, -1                          # size -= 1
  bnez t0, label_107                       # if there are still element to be copy, keep copying.
...
label_108:                                 # loop to create char table
...
strCat:
  ...
  beqz t0, label_109                       # TO is empty so just return T1
  beqz t1, label_110                       # T1 is empty so just return T0
  add t0, t0, t1                           # k
...
label_112:                                 # [ENTER BRANCH]: Loop and store for first string
  beqz t2, label_111                       # Finished storing T0, now do the same for T1
  ...
  j label_112                              # [JUMP]: Loop and store for T0
label_111:                                 # [ENTER BRANCH]: Reset config for second string looping
  lw t0, 0(fp)                             # Load second string to T0
  lw t2, 12(t0)                            # T2 = T0's length
  addi t0, t0, 16                          # T0 = content of 2nd string
label_113:                                 # [ENTER BRANCH]: Loop and store for second string
  beqz t2, label_114                       # Finish processing T1, jump to add null char to str
  lbu t3, 0(t0)                            # Load byte for second str
  sb t3, 0(t1)                             # Store byte into T1
  addi t2, t2, -1                          # Decrement T1's length by 1
  addi t1, t1, 1                           # Increment store __str__ address by 1
  addi t0, t0, 1                           # Increment str address by 1
  j label_113                              # [JUMP]: Loop and store for T1
label_109:                                 # [ENTER BRANCH]: T0 Empty Return T1
  lw a0, 0(fp)                             # Return T1
  j label_115                              # [JUMP]; Calling Convention Cleanup
label_110:                                 # [ENTER BRANCH]: T1 Empty Return T0
  lw a0, 4(fp)                             # Return T0
  j label_115                              # [JUMP]: Calling Convention Cleanup
label_114:                                 # [ENTER BRANCH]: Append Null Char to str
  sb zero, 0(t1)                           # Append null char to str
label_115:                                 # [ENTER BRANCH]: Calling Convention Cleanup
  lw ra, -4(fp)
  lw fp, -8(fp)
  addi sp, sp, 12
...
strEql:
  ...
  lw t0, 12(a1)                            # 
  lw t1, 12(a2)                            # 
  bne t0, t1, label_116                    # zero length handler
label_118:                                 # 
  lbu t2, 16(a1)                           # 
  lbu t3, 16(a2)                           # 
  bne t2, t3, label_116                    # 
...
const_2:
  ...
  .word 10                                 # Object size
  .word $str$dispatchTable                 # Pointer to dispatch table
  .word 22                                 # Constant value of attribute: __len__
  .string "Gimme your input ehehe"         # Constant value of attribute: __str__
  .align 2
...
const_3:
  ...
  .string "ending"                         # Constant value of attribute: __str__
  .align 2
...
const_24:
  ...
  .string "I got called!!!"                # Constant value of attribute: __str__
  .align 2
...
const_25:
  ...
  .word 16                                 # Object size
  .word $str$dispatchTable                 # Pointer to dispatch table
  .word 44                                 # Constant value of attribute: __len__
  .string "I was called with hope to constant propagate" # Constant value of attribute: __str__
  .align 2
