...
label_5:                                   # Index within bounds
  ...
  lw a0, -32(fp)                           # Load var: str_to_int.i
  lw a1, -52(fp)                           # Peek stack slot 12
  lw t0, 12(a1)                            # Load attribute: __len__
  bltu a0, t0, label_6                     # Ensure 0 <= idx < len
  j error.OOB                              # Go to error handler
label_6:                                   # Index within bounds
  sw a0, -56(fp)                           # Push on stack slot 14
  lw t0, -56(fp)                           # Pop stack slot 14
  lw a1, -52(fp)                           # Peek stack slot 12
  addi t0, t0, 16                          # Convert index to offset to char in bytes
  add t0, a1, t0                           # Get pointer to char
  lbu t0, 0(t0)                            # Load character
  ...
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  beqz a0, label_8                         # Branch on false.
  lw a0, -28(fp)                           # Load var: str_to_int.first_char
  bnez a0, label_9                         # Branch on true.
  li a0, 0                                 # Load integer literal 0
...
label_9:                                   # End of if-else statement
  ...
  j label_7                                # Then body complete; jump to end-if
label_8:                                   # Else body
  lw a0, -20(fp)                           # Load var: str_to_int.char
  sw a0, -44(fp)                           # Push argument 1 from last.
  ...
  jal streql                               # Call string == function
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  beqz a0, label_11                        # Branch on false.
  li a0, 0                                 # Load integer literal 0
...
label_11:                                  # Else body
  ...
  jal streql                               # Call string == function
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  beqz a0, label_13                        # Branch on false.
  li a0, 1                                 # Load integer literal 1
  sw a0, -16(fp)                           # Assign var: str_to_int.digit
  j label_12                               # Then body complete; jump to end-if
label_13:                                  # Else body
  lw a0, -20(fp)                           # Load var: str_to_int.char
  sw a0, -44(fp)                           # Push argument 1 from last.
  ...
  jal streql                               # Call string == function
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  beqz a0, label_15                        # Branch on false.
  li a0, 2                                 # Load integer literal 2
  sw a0, -16(fp)                           # Assign var: str_to_int.digit
  j label_14                               # Then body complete; jump to end-if
label_15:                                  # Else body
  lw a0, -20(fp)                           # Load var: str_to_int.char
  sw a0, -44(fp)                           # Push argument 1 from last.
  ...
  jal streql                               # Call string == function
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  beqz a0, label_17                        # Branch on false.
  li a0, 3                                 # Load integer literal 3
  sw a0, -16(fp)                           # Assign var: str_to_int.digit
  j label_16                               # Then body complete; jump to end-if
label_17:                                  # Else body
  lw a0, -20(fp)                           # Load var: str_to_int.char
  sw a0, -44(fp)                           # Push argument 1 from last.
  la a0, const_10                          # Load string literal
  ...
  jal streql                               # Call string == function
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  beqz a0, label_19                        # Branch on false.
  li a0, 3                                 # Load integer literal 3
  sw a0, -16(fp)                           # Assign var: str_to_int.digit
  j label_18                               # Then body complete; jump to end-if
label_19:                                  # Else body
  lw a0, -20(fp)                           # Load var: str_to_int.char
  sw a0, -44(fp)                           # Push argument 1 from last.
...
label_16:                                  # End of if-else statement
label_14:                                  # End of if-else statement
label_12:                                  # End of if-else statement
...
label_4:                                   # Test loop condition
  ...
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  lw t0, -36(fp)                           # Pop stack slot 9
  bge t0, a0, label_34                     # Branch on not <
  lw a0, 0(fp)                             # Load var: str_to_int.x
  sw a0, -52(fp)                           # Push on stack slot 13
  lw a0, -32(fp)                           # Load var: str_to_int.i
  lw a1, -52(fp)                           # Peek stack slot 12
  lw t0, 12(a1)                            # Load attribute: __len__
  bltu a0, t0, label_35                    # Ensure 0 <= idx < len
  j error.OOB                              # Go to error handler
label_35:                                  # Index within bounds
  sw a0, -56(fp)                           # Push on stack slot 14
  lw t0, -56(fp)                           # Pop stack slot 14
  lw a1, -52(fp)                           # Peek stack slot 12
  addi t0, t0, 16                          # Convert index to offset to char in bytes
  ...
  addi sp, fp, -@str_to_int.size           # Set SP to stack frame top.
  bnez a0, label_3                         # Branch on true.
label_34::
  lw a0, -12(fp)                           # Load var: str_to_int.result
  sw a0, -36(fp)                           # Push on stack slot 9
...
.globl $sqrt
$sqrt:
  addi sp, sp, -@sqrt.size                 # Reserve space for stack frame.
  sw ra, @sqrt.size-4(sp)                  # return address
  sw fp, @sqrt.size-8(sp)                  # control link
  addi fp, sp, @sqrt.size                  # New fp is at old SP.
  li a0, 1                                 # Load integer literal 1
  sw a0, -12(fp)                           # local variable i
  j label_39                               # Jump to loop test
label_38:                                  # Top of while loop
  lw a0, -12(fp)                           # Load var: sqrt.i
  sw a0, -16(fp)                           # Push on stack slot 4
  lw a0, -12(fp)                           # Load var: sqrt.i
  lw t0, -16(fp)                           # Pop stack slot 4
  mul a0, t0, a0                           # Operator *
  sw a0, -16(fp)                           # Push on stack slot 4
  lw a0, 0(fp)                             # Load var: sqrt.n
  lw t0, -16(fp)                           # Pop stack slot 4
  blt t0, a0, label_40                     # Branch on not >=
  lw a0, -12(fp)                           # Load var: sqrt.i
  j label_37                               # Go to return
label_40:                                  # End of if-else statement
  ...
  lw t0, -16(fp)                           # Pop stack slot 4
  add a0, t0, a0                           # Operator +
  sw a0, -12(fp)                           # Assign var: sqrt.i
label_39:                                  # Test loop condition
  lw a0, -12(fp)                           # Load var: sqrt.i
  sw a0, -16(fp)                           # Push on stack slot 4
  lw a0, 0(fp)                             # Load var: sqrt.n
  lw t0, -16(fp)                           # Pop stack slot 4
  blt t0, a0, label_38                     # Branch on <
  li a0, 1                                 # Load integer literal 1
  sub a0, zero, a0                         # Unary negation
  j label_37                               # Go to return
  mv a0, zero                              # Load None
  j label_37                               # Jump to function epilogue
label_37:                                  # Epilogue
  .equiv @sqrt.size, 16
  lw ra, -4(fp)                            # Get return address
  lw fp, -8(fp)                            # Use control link to restore caller's fp
  addi sp, sp, @sqrt.size                  # Restore stack pointer
  jr ra                                    # Return to caller
...
$main:
  ...
  jal $input                               # Invoke function: input
  addi sp, fp, -@main.size                 # Set SP to stack frame top.
  ...
  addi sp, fp, -@main.size                 # Set SP to stack frame top.
  mv a0, zero                              # Load None
  j label_42                               # Jump to function epilogue
label_42:                                  # Epilogue
  .equiv @main.size, 32
  lw ra, -4(fp)                            # Get return address
  lw fp, -8(fp)                            # Use control link to restore caller's fp
  addi sp, sp, @main.size                  # Restore stack pointer
  jr ra                                    # Return to caller
